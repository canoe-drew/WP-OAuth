...
<div class='wrap wpoa-settings'>
	...
	<div id="wpoa-settings-col1" class="wpoa-settings-column">
		<form method='post' action='options.php'>
			...
			<!-- START Login with idQ section -->
			<div id="wpoa-settings-section-login-with-idq" class="wpoa-settings-section">
			<h3>Login with idQ</h3>
			<div class='form-padding'>
			<table class='form-table'>
				<tr valign='top'>
				<th scope='row'>Enabled:</th>
				<td>
					<input type='checkbox' name='wpoa_idq_api_enabled' value='1' <?php checked(get_option('wpoa_idq_api_enabled') == 1); ?> />
				</td>
				</tr>
				...
				<th scope='row'>Client ID:</th>
				<td>
					<input type='text' name='wpoa_idq_api_id' value='<?php echo get_option('wpoa_idq_api_id'); ?>' />
				</td>
				</tr>
				...
				<th scope='row'>Client Secret:</th>
				<td>
					<input type='text' name='wpoa_idq_api_secret' value='<?php echo get_option('wpoa_idq_api_secret'); ?>' />
				</td>
				</tr>
			</table> <!-- .form-table -->
			<p>
				<strong>Instructions:</strong>
				<ol>
					<li>Visit the idQ website and log in to the account portal: <a href='https://idquanta.com' target="_blank">idquanta.com</a>.</li>
					<li>At idQ, create a new application. </li>
					<li>At idQ, provide your site's homepage URL (<?php echo $blog_url; ?>) in the callback URL. Don't forget the trailing slash!</li>
					<li>Paste your Client ID/Secret provided by idQ into the fields above, then click the Save all settings button.</li>
				</ol>
			</p>
			<?php submit_button('Save all settings'); ?>
			</div> <!-- .form-padding -->
			</div> <!-- .wpoa-settings-section -->
			<!-- END Login with idQ section -->
